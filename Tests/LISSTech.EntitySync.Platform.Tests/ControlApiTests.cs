...
public sealed class ControlApiTests(ControlApiFactory factory)
{
    ...
    [
        ...
        (HttpMethod.Get, "/api/v1/control/vendors", ControlPolicies.Read),
        (HttpMethod.Get, "/api/v1/control/connections/{connectionId}/entity-refreshes", ControlPolicies.Read),
        (HttpMethod.Post, "/api/v1/control/connections/{connectionId}/entity-refreshes", ControlPolicies.Operate),
        (HttpMethod.Post, "/api/v1/control/connections/{connectionId}/entity-events", ControlPolicies.CanonicalChanges),
    ...
    public void State_mutations_declare_idempotency_and_schedule_preview_does_not()
    {
        var atomicRoutes = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "/api/v1/control/connections/{connectionId}/entity-events",
            "/api/v1/control/connections/{connectionId}/entity-refreshes",
