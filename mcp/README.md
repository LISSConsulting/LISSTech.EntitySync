...
- The edges execute in order. NetSuite-to-HaloPSA completes before HaloPSA is reread for each leaf. A connection, planning, validation, approval, or apply failure marks the affected edge and aggregate run failed but does not stop later edges.
